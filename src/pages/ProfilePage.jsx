...
const ProfilePage = () => {
  ...
  if (error) return <ShowError illustration={errorTrash} message={error} />;
  ...
  const handleInfoChange = async (e) => {
    ...
    try {
      if (
        ...
        toastify('Display and email must be different.', 'error');
        return;
      }

      const accessToken = await changePersonalInfo(token, {
  ...
  const handlePasswordChange = async (e) => {
    ...
    try {
      if (passwords.currentPassword === passwords.newPassword) {
        toastify('New password  must be different.', 'error');
        return;
      }

      const accessToken = await changePassword(token, {
        ...
        <DangerZone>
          <div>
            ...
            <SmallText>
              ...
              will lose all of your files and profile information.
            </SmallText>
          </div>
          <Button
            type="button"
